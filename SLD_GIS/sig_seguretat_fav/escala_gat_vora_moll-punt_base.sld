			...
			<se:FeatureTypeStyle>
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_fav_co\ESCALA_GAT_VORA_MOLL-no_classificat.svg"/>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_fav_co\ESCALA_GAT_VORA_MOLL-interior(esta_dins_un_entrant_de_vora-moll).svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.010180</Size>
						</Graphic>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_fav_co\ESCALA_GAT_VORA_MOLL-exterior(esta_en_la_paret_de_vora-moll_sense_cap_proteccio).svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.010180</Size>
						</Graphic>
