			...
			<se:FeatureTypeStyle>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="sig_seguretat\BARRERA_ANTICONTAMINACIO-no classificat.svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.360460</Size>
						</Graphic>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="sig_seguretat\BARRERA_ANTICONTAMINACIO-no definit.svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.360460</Size>
						</Graphic>
