			...
			<se:FeatureTypeStyle>
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_bn\ESCALA_GAT_VORA_MOLL-no classificat.svg"/>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_bn\ESCALA_GAT_VORA_MOLL-interior (esta dins un entrant de vora-moll).svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.010180</Size>
						</Graphic>
				...
				<Rule>
					...
					<PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<Graphic>
							<ExternalGraphic>
								<OnlineResource xlink:type="simple" xlink:href="plaport_bn\ESCALA_GAT_VORA_MOLL-exterior (esta en la paret de vora-moll sense cap proteccio).svg"/>
								<Format>image/svg+xml</Format>
							</ExternalGraphic>
							<Size>0.010180</Size>
						</Graphic>
